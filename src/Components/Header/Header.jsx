    ...
    <div className={styles.headWrapper}>
      <header className={styles.header}>
        <section className={styles.headerContent}>
          ...
          <section className={styles.iconmenuWrapper}>
            <div className={styles.humbergerMenu}>
              <div
                className={
                  humber ? styles.humbergerMenuT : styles.humbergerMenuF
                }
                onClick={() => {
            ...
            <div className={styles.signUpIcon}>
              <div
                className={user ? styles.signUpIconT : styles.signUpIconF}
                onClick={() => {
        ...
        <section className={styles.menuRContainer}>
          ...
          <nav
            className={`${styles.menuRContent} ${
              humber ? styles.menuRContentT : styles.menuRContentF
            }`}
          >
            <ul>
              <li>
          ...
          <nav
            className={`${styles.userRContent} ${
              user ? styles.userRContentT : styles.userRContentF
            } `}
          >
            <ul>
              <li>
